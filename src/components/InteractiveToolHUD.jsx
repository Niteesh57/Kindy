...
export const MAP_PRESET_WAYPOINTS = [
  {
    name: 'Ferry Building Coffee',
    city: 'San Francisco',
    category: 'Cafe · 4.9 ★',
    query: 'Find coffee shops near Ferry Building in San Francisco that are open now',
    x: 260,
    y: 85,
    tag: 'OPEN NOW',
    tagBg: '#e6f4ea',
  ...
  },
  {
    ...
    query: 'Find scenic walking trails and viewpoints in Central Park',
    x: 120,
    y: 100,
    tag: 'SCENIC',
    tagBg: '#e6f4ea',

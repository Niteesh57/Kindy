...
export const BG_COLORS = [
  { label: 'Clean Slate', value: '#f1f5f9' },
  { label: 'Soft Rose', value: '#ffe4e6' },
  { label: 'Lavender Dream', value: '#ede9fe' },
  { label: 'Sky Azure', value: '#e0f2fe' },
  { label: 'Mint Glow', value: '#dcfce7' },
  { label: 'Warm Cream', value: '#fef3c7' },
  { label: 'Peach Blush', value: '#ffedd5' },
  { label: 'Midnight Blue', value: '#1e1b4b' },
  { label: 'Charcoal', value: '#0f172a' },
  { label: 'Pure Studio White', value: '#ffffff' },
];
